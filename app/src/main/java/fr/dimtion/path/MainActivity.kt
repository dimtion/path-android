...
class MainActivity : AppCompatActivity() {
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult?) {
                ...
                for (location in locationResult.locations) {
                    ...
                    Log.i("loc fused", location.toString())
                }
            }
        }
        requestPermissions()
    ...
    private fun createLocationRequest() {
        ...
        if (locationRequest == null) {
            Log.e("loc", "Could not create locationRequest")
            return
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            REQUEST_CHECK_SETTINGS -> {
                Log.i("activityResult", "OnActivityResult REQUEST_CHECK_SETTINGS, $requestCode, $data")
                initLocationClient()
    ...
    private fun requestPermissions() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(
                ...
                Log.i("perm", "Showing permission rationale")
            } else {
            ...
            Log.i("perm", "Location permission already granted")
            initLocationClient()
            createLocationRequest()
        }
    }
